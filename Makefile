...
# seed = $(shell python3 -c 'from random import randint; print(randint(1023, 65535));') #random seed in hex (The maximum seed length should not exceed 256-bits)
...
build_keygen: 
	...
	cp ./hardware/common/poly_mult/poly_mult_new.v	./build/keygen/
	...
	python3 ./build/keygen/seed_align.py seed_align $(pk_seed) $(pk_seed_filename) 	# aligning seed for the hardware input
	python3 ./build/keygen/seed_align.py seed_align $(sk_seed) $(sk_seed_filename)	# aligning seed for the hardware input
...
build_encap: 
	...
	cp ./hardware/common/poly_mult/poly_mult_new.v	./build/encap/
	...
	python3 ./build/encap/seed_align.py seed_align $(msg_128) 16 $(msg128_file_name) "no"	# aligning seed for the hardware input
	python3 ./build/encap/seed_align.py seed_align $(msg_192) 24 $(msg192_file_name) "no"	# aligning seed for the hardware input
	python3 ./build/encap/seed_align.py seed_align $(msg_256) 32 $(msg256_file_name) "no"	# aligning seed for the hardware input
...
build_decap: 
	...
	cp ./hardware/common/poly_mult/poly_mult_new.v	./build/decap/
...
build_joint_design:
	...
	cp ./hardware/common/poly_mult/poly_mult_new.v	./build/joint_design/
	...
	python3 ./build/joint_design/seed_align.py seed_align $(pk_seed) 40 $(pk_seed_filename) "yes"	# aligning seed for the hardware input
	python3 ./build/joint_design/seed_align.py seed_align $(sk_seed) 40 $(sk_seed_filename) "yes"	# aligning seed for the hardware input


	python3 ./build/joint_design/seed_align.py seed_align $(msg_128) 16 $(msg128_file_name) "no"	# aligning seed for the hardware input
	python3 ./build/joint_design/seed_align.py seed_align $(msg_192) 24 $(msg192_file_name) "no"	# aligning seed for the hardware input
	python3 ./build/joint_design/seed_align.py seed_align $(msg_256) 32 $(msg256_file_name) "no"	# aligning seed for the hardware input
